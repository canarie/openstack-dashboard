...
urlpatterns = patterns('',
    ...
    url(r'^(?P<project_id>[^/]+)/floatingips$',
        'django_openstack.nova.views.floatingips.index',
        name='nova_floatingips'),
    url(r'^(?P<project_id>[^/]+)/floatingips/allocate$',
        'django_openstack.nova.views.floatingips.allocate',
        name='nova_floatingips_allocate'),
    url(r'^(?P<project_id>[^/]+)/floatingips/(?P<floating_ip>[^/]+)/release$',
        'django_openstack.nova.views.floatingips.release',
        name='nova_floatingips_release'),
    url(r'^(?P<project_id>[^/]+)/floatingips/associate$',
        'django_openstack.nova.views.floatingips.associate',
        name='nova_floatingips_associate'),
    url(r'^(?P<project_id>[^/]+)/floatingips/(?P<floating_ip>[^/]+)/disassociate$',
        'django_openstack.nova.views.floatingips.disassociate',
        name='nova_floatingips_disassociate'),
)
